...
const TECHNOLOGIES = [
  'React', 'Next.js', 'Vue', 'Nuxt', 'Pinia', 'Astro', 'Svelte', 'Angular',
  'Tailwind CSS', 'shadcn/ui', 'TypeScript', 'Playwright', 'Supabase', 'Neon',
  'Expo', 'React Native', 'Remotion', 'Better Auth', 'Turborepo', 'Vite',
...
for (const tech of TECHNOLOGIES) {
  ...
  const svgUrl = typeof match.route === 'string'
    ? match.route
    : (match.route.dark || match.route.light)
